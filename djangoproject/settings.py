...
SECRET_KEY = os.environ.get("SECRET_KEY", "chave-temporaria-caso-env-falhe")
...
DATABASES = {
    'default': {
            ...
            'HOST': os.environ.get('DB_HOST', 'db'),  # O NOME DO SERVIÇO NO DOCKER
...
# Opcional: Para evitar os avisos (Warnings) de Primary Key que apareceram no seu log
