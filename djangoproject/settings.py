...
CORS_ALLOW_HEADERS = [
    ...
    'x-csrftoken',
    'x-requested-with',
    'ngrok-skip-browser-warning',  # O header que seu React está enviando
]
...
# Os arquivos ficam em: backend/mediafiles/produtos/<categoria>/
# A URL de acesso é: http://<host>:8000/media/produtos/<arquivo>
# ---------------------------------------------------------------
MEDIA_URL  = '/media/'
