...
from rest_framework_nested import routers as nested_routers  # pip install drf-nested-routers
from rest_framework_simplejwt.views import TokenVerifyView

from .views import (
    LoginView, RegistroView, RefreshView, LogoutView,
    CategoriaViewSet, ProdutoViewSet, PagamentoViewSet,
    ClienteViewSet, EnderecoViewSet, PedidoViewSet,
    ItensPedidoViewSet, AvaliacaoViewSet,
